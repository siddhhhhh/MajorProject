...
KNOWN_GREENWASHING_CASES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "industry": "banking",
        "claim": "JPMorgan Chase committed to net-zero financed emissions by 2050 while financing Saguaro Energía LNG export terminal in Mexico",
        "outcome": "CONFIRMED_GREENWASHING",
        "regulatory_action": "ClientEarth complaint + OECD National Contact Point filing (2024) over Saguaro Energía LNG project; lawsuit from Indigenous Comcaac community alleging inadequate FPIC; bank named in Rainforest Action Network 'Banking on Climate Chaos' as largest fossil fuel financier ($430B 2016-2023)",
        "source": "ClientEarth (clientearth.us); RAN Banking on Climate Chaos 2024; OECD Watch",
        "year": 2024,
        "expected_gw_range": [55, 80],
        "expected_esg_range": [40, 60],
        "severity": "HIGH",
        "jurisdiction": "US/Mexico/Global",
    },
    {
        "case_id": "GW-012",
        "company": "ExxonMobil",
        "industry": "oil_and_gas",
        "claim": "ExxonMobil publicly accepted climate science while internal documents showed decades of climate-risk concealment",
        "outcome": "CONFIRMED_GREENWASHING",
        "regulatory_action": "Commonwealth of Massachusetts v Exxon Mobil Corp. (filed Oct 2019, Mass SJC affirmed standing May 2022, in trial preparation 2024); state-AG consumer-protection claims for misleading investors and consumers on climate impact",
        "source": "Mass AG Office; Sabin Center Climate Change Litigation Database (Massachusetts v Exxon Mobil)",
        "year": 2024,
        "expected_gw_range": [70, 95],
        "expected_esg_range": [20, 40],
        "severity": "HIGH",
        "jurisdiction": "US",
    },
    {
        ...
        "company": "Adani Group",
        "industry": "energy",
        "claim": "Adani Group claimed sustainability leadership and green expansion while regulators investigated stock-price manipulation and disclosure failures",
        "outcome": "CONFIRMED_GREENWASHING",
        "regulatory_action": "SEBI investigation into 24 Adani-group matters (2023-2024); Supreme Court of India expert committee report (May 2023); US DOJ + SEC indictment of Gautam Adani and others for alleged bribery scheme (Nov 2024)",
        "source": "SEBI orders; SC Expert Committee (Justice Sapre); US DOJ EDNY indictment 1:24-cr-00543",
        "year": 2024,
        "expected_gw_range": [70, 95],
        "expected_esg_range": [15, 40],
        "severity": "CRITICAL",
